...
ALTER TABLE "community_goal_meta" ADD CONSTRAINT "a4_community_meta_key_community_goal_meta_key_key_fk" FOREIGN KEY ("key") REFERENCES "community_goal_meta_key" ("key");
ALTER TABLE "balance" ADD CONSTRAINT "a4_balance_community_id_fk" FOREIGN KEY ("community_id") REFERENCES "community" ("id");
...
ALTER TABLE "invitee" ADD CONSTRAINT "a4_invitee_community_id_fk" FOREIGN KEY ("community_id") REFERENCES "community" ("id");
...
ALTER TABLE "transaction" ADD CONSTRAINT "a4_transaction_community_goal_id_fk" FOREIGN KEY ("community_goal_id") REFERENCES "community_goal" ("id");
